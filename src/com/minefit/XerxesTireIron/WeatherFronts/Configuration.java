            ...
            if (allFronts) {
                ...
                while (iterator.hasNext()) {
                    ...
                    if (main_config.getBoolean("worlds-enabled." + worldName)) {
                        ...
                        File simulatorsFile = new File(plugin.getDataFolder() + File.separator + worldName + File.separator
                                + "simulators.yml");
                        simulators_temp.load(simulatorsFile);

                        YamlConfiguration fronts_temp = new YamlConfiguration();
                        File frontsFile = new File(plugin.getDataFolder() + File.separator + worldName + File.separator
                                + "fronts.yml");
